...
class MovimentsController {
  ...
  static async listExpensesByMonth(month = new Date().getMonth() + 1) {
    const res = await request.get(`/moviments?type=expenses&date_gte=2023-${month}-01T00:00:00Z&date_lte=2023-${month}-31T23:59:59Z`)

    return res.data
  }

  static async listExpensesPaymentByMonth(month = new Date().getMonth() + 1) {
    const res = await request.get(`/moviments?type=expenses&status=${PAGO}&date_gte=2023-${month}-01T00:00:00Z&date_lte=2023-${month}-31T23:59:59Z`)

    return res.data
  }

  static async listExpensesPaymentWaitingByMonth(month = new Date().getMonth() + 1) {
    const res = await request.get(`/moviments?type=expenses&status=${A_PAGAR}&date_gte=2023-${month}-01T00:00:00Z&date_lte=2023-${month}-31T23:59:59Z`)
  ...
  static async listRecipesByMonth(month = new Date().getMonth() + 1) {
    const res = await request.get(`/moviments?type=recipes&date_gte=2023-${month}-01T00:00:00Z&date_lte=2023-${month}-31T23:59:59Z`)

    return res.data
  }

  static async listRecipesReceivedByMonth(month = new Date().getMonth() + 1) {
    const res = await request.get(`/moviments?type=recipes&status=${RECEBIDO}&date_gte=2023-${month}-01T00:00:00Z&date_lte=2023-${month}-31T23:59:59Z`)

    return res.data
  }

  static async listRecipesReceiveWaitingByMonth(month = new Date().getMonth() + 1) {
    const res = await request.get(`/moviments?type=recipes&status=${A_RECEBER}&date_gte=2023-${month}-01T00:00:00Z&date_lte=2023-${month}-31T23:59:59Z`)
